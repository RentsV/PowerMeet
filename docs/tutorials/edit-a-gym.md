...
You can use the PUT call to replace an existing entry.
The other option is to use the PATCH call to change one or more fields of an existing entry.
In both cases, it's important to use the correct ID number in the URL.
This is how the system finds the entry to edit.
...
6. Watch for the response body, which should look something like this.
7. Note that the information should be the same as you used in your **Request body**.
